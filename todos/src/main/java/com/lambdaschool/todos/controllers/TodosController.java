...
public class TodosController
{
    ...
    public ResponseEntity<?> addNewTodo(@RequestBody String description, @PathVariable Long userid) throws URISyntaxException {
        Todos newTodo = todosService.addTodo(userid, description);
